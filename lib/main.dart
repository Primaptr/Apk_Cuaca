...
import 'package:prima_appcuaca/weather_model.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Mobile Programming-Pert 9',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: MyHomePage(title: 'Flutter App Cuaca'),
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _onTap() async {
    ...
    try {
      var param = {"q": _lokasi, "APPID": "7ab0ace0a5d8b1765c718e1c22c9ab2f"};
